...
💡 Навіть NewSQL-системи (CockroachDB, Spanner) будуються на цій моделі
...
CREATE TABLE departments (
    id SERIAL PRIMARY KEY,  -- Автогенерований (або GENERATED ALWAYS AS IDENTITY)
...
- NewSQL (CockroachDB, Spanner, YugabyteDB) — ACID + горизонтальне масштабування

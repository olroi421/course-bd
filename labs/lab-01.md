...
8. Створити файл `lab01-report.md` за шаблоном ([📑 Завантажити шаблон](assets/lab01-report-template.md)). Додати опис виконаних запитів та результатів. Включити скріншоти.

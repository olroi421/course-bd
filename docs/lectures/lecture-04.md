...
Хоча реляційна модель була розроблена понад 50 років тому, вона продовжує бути актуальною та розвиватися. Сучасні розширення включають підтримку XML, JSON, масивів та інших складних типів даних, зберігаючи при цому основні принципи реляційної моделі.
